...
filepath = 'C:\\Users\\archana\\Downloads\\Plant-Leaf-Disease-Prediction-main\\Plant-Leaf-Disease-Prediction-main\\model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:\Users\archana\Downloads\Plant-Leaf-Disease-Prediction-main\Plant-Leaf-Disease-Prediction-main\static\upload\Tomato___Bacterial_spot (4).JPG')
